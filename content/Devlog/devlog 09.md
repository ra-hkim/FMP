...
### Enemy stats
I also found another issue with the enemy stats not setting properly so firstly I set up another debug script for my enemy stats, below is an append string node 
